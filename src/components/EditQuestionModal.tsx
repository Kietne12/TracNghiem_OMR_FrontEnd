...
export default function EditQuestionModal({ question, chapters, onEdit, onClose }: EditQuestionModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-screen overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-slate-200 p-6 flex justify-between items-center">
          <h2 className="text-2xl font-bold text-slate-800">Chỉnh sửa câu hỏi</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="bg-slate-50 rounded-lg p-4 text-sm text-slate-600 border border-slate-200">
            <p>Câu hỏi này đã được sử dụng {question.uses} lần</p>
            <p>Được tạo vào: {question.createdAt}</p>
          </div>
